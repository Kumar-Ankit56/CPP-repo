...
class Complex{
   ...
   public:
    ...
    friend void fun(); ///as by previous lecture we have seen friend function is only declare in the class scope can be anything but it will defined.
...
void fun(Complex c1){
     //cout<<"Sum of the number is :"<<c1.a+c1.b;//we also cant do it as it has power to access the member of its friend class but it cant d direct. it is so because it not giving any sense that which is their obbject as c1,c2 or anything.
     c1.showdata();
}
int main(){
